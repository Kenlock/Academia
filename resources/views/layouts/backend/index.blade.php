...
<body>
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-expand-md"
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center">
        <img class="navbar-brand-logo" src="{{ asset('backend/assets/images/b_logo.png') }}" title="SG_academy">
        <span class="navbar-brand-text hidden-xs-down"> SG Academy</span>
      </div>
  ...
  <footer class="site-footer">
    <div class="site-footer-legal">© {{ date('Y') }} <a href="javascript:void(0)">SG Academy</a></div>
  </footer>
  <!-- Core  -->
