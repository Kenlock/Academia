  ...
  <div>
    <div>
      <ul class="site-menu" data-plugin="menu">
        ...
        <li class="site-menu-item {{ request()->is('admin/becomeInstructor*') ? 'active' : '' }}">
            <a href="{{ route('admin.becomeInstructor') }}">
                <i class="site-menu-icon fab fa-creative-commons-by" aria-hidden="true"></i>
                <span class="site-menu-title">Instructor Request</span>
            </a>
        </li>
