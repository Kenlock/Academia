    ...
    <div class="container-fluid p-0 home-content">
        ...
        <div class="homepage-slide-blue">
            ...
            <div class="searchbox-contrainer col-md-6 mx-auto">
                <input name="keyword" type="text" class="searchbox d-none d-sm-inline-block" placeholder="Search for courses by course titles"><button type="submit" class="searchbox-submit"><i class="fa fa-search"></i></button>
            </div>
            </form> -->
        </div>
        <!-- banner end -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <h3 class="dblock-heading">Learn available topics, instructors will add their own</h3>
                        <p class="dblock-text">The courses are made by instructors and admins to help you learn online. These courses ranges from college topics, professional and specialization topics and others.</p>
        ...
        <article class="learn-block">
            <div class="container">
                <div class="row">
                  <div class="col-xl-6 col-lg-6 col-md-6 vertical-align">
                      <img class="img-fluid mt-5 mx-auto" src="{{ asset('frontend/img/landing2.png') }}">
                  </div>
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <h3 class="dblock-heading">For Students and Instructors</h3>
                        <p class="dblock-text">We help students and instructors with their studying and teaching with our website.</p>
                        <a href="{{ route('login') }}" class="btn btn-ulearn">Register Now!</a>
                    </div>
