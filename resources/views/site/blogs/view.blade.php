            ...
            <div class="row mt-4">
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 d-none d-md-block">
                    <section class="course-feature">
                        <h6 class="text-center mt-3">SUBSCRIBE TO SG Academy BLOG</h6>

                        <div class="pl-3 pr-2">
                            <p>We will send you newsletters or blogs about events that will happen with the site or with the learning here in the Philippines.</p>
