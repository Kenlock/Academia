                    ...
                    <div class="row cv-header">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 float-md-right col-sm-6 float-sm-right col-6">
                            <div class="btn-group" role="group" aria-label="Basic example">
                              <div class="hidden" id="course_id">{{$course->id}}</div>
                              @if(\Auth::user())
                                @if($course->price > 0)
                                    <button id="addtocart" class="btn btn-success">ADD TO CART</button>
                                    <a href="{{ route('course.checkout', $course->course_slug) }}" class="btn btn-primary">BUY NOW</a>
                                @else
                                    <a href="{{ route('course.checkout', $course->course_slug) }}" class="btn btn-primary">ENROLL COURSE</a>
                                @endif
                              @else
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 d-none d-md-block">
                <section class="course-feature">
                    ...
                    <div class="cf-pricing">
                        <span>PRICING:</span>
                        <h4 style="color: red;">{{ $course->price ? 'PHP' . $course->price : 'FREE' }}</h4>
                    </div>

                    <ul class="list-unstyled cf-pricing-li">
                        <li><i class="far fa-user"></i>{{$count}} enrolled student(s)</li>
