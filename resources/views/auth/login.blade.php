    ...
    <div class="container-fluid p-0 home-content container-top-border">
        ...
        <div class="container">
          ...
          <ul role="tablist" class="nav bg-light nav-pills rounded-pill nav-fill mb-3">
            <li class="nav-item">
              <a data-toggle="pill" href="#login-card" class="nav-link active rounded-pill"><b>Login</b></a>
            </li>
            <li class="nav-item">
              <a data-toggle="pill" href="#register-card" class="nav-link rounded-pill"><b>Register</b></a>
            </li>
          </ul>
          <!-- End -->
          ...
          <!-- login card -->
          <div id="login-card" class="tab-pane fade show active">
            <div class="row">
            ...
            <!-- end of the login card -->

            <!-- start of the register card -->
            <div id="register-card" class="tab-pane fade">
              <div class="row">
                  <div class="col-xl-6 col-lg-6 col-md-6 vertical-align d-none d-lg-block">
                      <img class="img-fluid" src="{{ asset('frontend/img/fimg.png') }}" width="500px" height="500px">
                  </div>
