<ul class="nav nav-tabs mb-4">
    <li class="nav-item">
        <a class="nav-link py-1 {{ request()->is('instructor-course-info*') ? 'active' : '' }}" href="@if($course->id) {{ route('instructor.course.info.edit', $course->id) }} @else {{ route('instructor.course.create') }} @endif">Course Info</a>
    </li>
    <li class="nav-item">
